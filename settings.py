...
############################
# EXTRA MEZZANINE SETTINGS #
############################

# A tag line that will appear at the top of all pages.
SITE_TAGLINE = 'Base Template for a site'

# Title that will display at the top of the site, and be appended to the content of the HTML title tags on every page.
SITE_TITLE = 'Your Name Here'

# A comma separated list of email addresses that will receive an
# mail notification each time a new account is created that requires approval.
ACCOUNTS_APPROVAL_EMAILS = ''

# If True, when users create an account, they will not be enabled by default
# and a staff member will need to activate their account in the admin interface.
ACCOUNTS_APPROVAL_REQUIRED = False

# If True, the username field will be excluded from sign up and account update forms.
ACCOUNTS_NO_USERNAME = True

# If True, when users create an account, they will be sent an email
# with a verification link, which they must click to enable their account.
...
# Access token anbd username for http://bit.ly URL shortening service.
BITLY_ACCESS_TOKEN = ''
BLOG_BITLY_USER = ''
...
### There are a stack of comment settings which can be changed in the admin panel, so not included here
...
RICHTEXT_ALLOWED_ATTRIBUTES = ('abbr', 'accept', 'accept-charset', 'accesskey', 'action', 'align', 'alt', 'axis',
    'border', 'cellpadding', 'cellspacing', 'char', 'charoff', 'charset', 'checked', 'cite', 'class', 'clear', 'cols',
    'colspan', 'color', 'compact', 'coords', 'datetime', 'dir', 'disabled', 'enctype', 'for', 'frame', 'headers',
    'height', 'href', 'hreflang', 'hspace', 'id', 'ismap', 'label', 'lang', 'longdesc', 'maxlength', 'media', 'method',
    'multiple', 'name', 'nohref', 'noshade', 'nowrap', 'prompt', 'readonly', 'rel', 'rev', 'rows', 'rowspan', 'rules',
    'scope', 'selected', 'shape', 'size', 'span', 'src', 'start', 'style', 'summary', 'tabindex', 'target', 'title',
...
RICHTEXT_ALLOWED_TAGS = ('a', 'abbr', 'acronym', 'address', 'area', 'article', 'aside', 'b', 'bdo', 'big',
    'blockquote', 'br', 'button', 'caption', 'center', 'cite', 'code', 'col', 'colgroup', 'dd', 'del', 'dfn', 'dir',
    'div', 'dl', 'dt', 'em', 'fieldset', 'figure', 'font', 'footer', 'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
    'header', 'hr', 'i', 'img', 'input', 'ins', 'kbd', 'label', 'legend', 'li', 'map', 'men', 'nav', 'ol', 'optgroup',
    'option', 'p', 'pre', 'q', 's', 'samp', 'section', 'select', 'small', 'span', 'strike', 'strong', 'sub', 'sup',
    'table', 'tbody', 'td', 'textarea', 'tfoot', 'th', 'thead', 'tr', 'tt', '', 'ul', 'var', 'wbr', 'pre')
